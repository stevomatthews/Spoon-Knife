...
`srt_bind` or `srt_connect`, and in this case `SRT_EINVPARAM` will not be used (see [`srt_bind`](#int-srt_bindSRTSOCKET-u-const-struct-sockaddr-name-int-namelen) above).<br><br>
